...
we take the resulting connective candidates, and contruct 
...
We are able to achive higher performance on relation type classification.
...
The same 10-fold for paragraphs is used, and the precsion, recall, and F1 scores
