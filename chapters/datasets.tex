...
\begin{sent}{sent:cdtb}{}
    ...
    [\underline{但}这种法制紧跟经济和社会活动的做法，
    受到了国内外投资者的好评，]\textsuperscript{d}
    [他们认为，到浦东新区投资办事有章法，]\textsuperscript{e}
    [讲规矩，]\textsuperscript{f}
    [利益能得到保障。]\textsuperscript{g}
...
the third-level relation types from now on to avoid confusion.
...
The length distribution for the connectives is shown in Table~\ref{t:connective-length}.
...
While there are total 274 classes of connectives, there are only 227 classes
...
spurious components, there exists a component candidate that involves in as many
...
has three components, but it only has two arguments.
...
dataset~\citep{callan2009clueweb09}. In NTU PN-Gram, there are total 173,741,587
