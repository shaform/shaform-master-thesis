...
The relation 1 has two arguments (a-b) and (c-d), and relation 2 has two
arguments (a) and (b).
...
pointed out the difficulty to determine argument spans due to the hierarchical nature
...
relation type for 7,601 sentences that have only two discourse units.
