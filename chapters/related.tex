...
This is represented by the children of an internal node. Each relation can be
either binary or multi-child. Figure~\ref{i:rst-tree} shows an example sub-tree.
...
for our study as it has both discourse connective annotations and discourse
...
set that includes all connective components. They achieved 98.9\%
accuracy for the 99 sentences that have linking ambiguities.
